...
**Q59. Which of the following are common goals of data wrangling?**  
...
<!--
Answer: c, d
Reason: Data wrangling aims to improve quality and make data easier to access, not increase complexity or ignore inconsistencies.
-->
...
**Q93. A major challenge in data wrangling is:**
...
<!--
Answer: c
Reason: Privacy and security are explicitly treated as major challenges in the wrangling process.
-->
...
**Q1. How do you make text italic in Markdown?**  
`Select all that apply`
...
<!--
Answer: c, d
Reason: Markdown italic is commonly written with *text* or _text_.
-->
...
**Q9. Which of the following are considered tasks in the Data Wrangling process?**  
`Select all that apply`
...
<!--
Answer: b, c, e
Reason: Storing, validation, and cleaning are core wrangling tasks in the Week 2 pipeline.
-->
...
**Q68. Factors to consider during the data collection phase include:**  
`Select all that apply`
...
<!--
Answer: a, b, c
Reason: Collection planning focuses on methods, source reliability, and format; storage physical location is not the key collection criterion here.
-->
...
**Q36. Data standardization helps ensure data is:**
...
<!--
Answer: a
Reason: Standardization is about making data consistent across records and datasets.
-->
...
<!--
Answer: a, b, c
Reason: Cleaning targets errors, duplicates, and missing values; it should not introduce new errors.
-->
...
**Q14. The goals of data enrichment include:**  
`Select all that apply`
...
<!--
Answer: a, b, c
Reason: Enrichment adds value and context that can improve quality and analysis capability; simplifying formats is not its primary goal.
-->
...
**Q108. In data wrangling, data validation ensures:**  
`Select all that apply`
...
<!--
Answer: a, b, d
Reason: Validation checks standards, reliability, and usability; it does not promote inconsistency.
-->
...
**Q10. What aspects does Data Cataloging and Metadata Management cover?**  
`Select all that apply`
...
<!--
Answer: a, c, d, e
Reason: Cataloging and metadata management cover collecting metadata, documenting lineage, usage metadata, and creating a searchable catalog.
-->
...
**Q16. Which method is used to get a summary of a DataFrame's structure and column types?**
...
<!--
Answer: a
Reason: df.info() shows column names, non-null counts, and dtypes; df.describe() summarizes statistics for values.
-->
